      ...
      <div className="navbar-container">
        ...
        <div className="branding">
          ...
          <a href="mailto: renanbrayner@gmail.com">
            <FiMail className="icon" color="#3d55dd" />
          </a>
          <a
          ...
          >
            <FiGithub className="icon" color="#3d55dd" />
          </a>
          <a
            href="https://www.linkedin.com/in/renan-brayner-a2a6b31a2/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FiLinkedin className="icon" color="#3d55dd" />
          </a>
        </div>
        <DrawerToggleButton
          className="hamburguer"
          click={toggleButtonHandleClick}
        />
